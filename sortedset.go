...
// 	elementCount int32 //total element number
// 	elementBytes int64 //total element bytes
// 	dict         sync.Map
// 	skiplist     *skiplist
...
// func (sortedSet *SortedSet) Add(member string, score int64, value CacheItem) {
...
// 		atomic.AddInt64(&sortedSet.elementBytes, int64(value.CacheBytes()))
...
// 	}
// 	atomic.AddInt32(&sortedSet.elementCount, -1)
// 	atomic.AddInt64(&sortedSet.elementBytes, -int64(element.(CacheItem).CacheBytes()))
// 	elementScore := element.(*Element).Score
// 	fc := func() {
// 		sortedSet.skiplist.remove(member, elementScore)
// 	}
...
// func (sortedSet *SortedSet) TotalBytes() int64 {
// 	return sortedSet.elementBytes
// }
...
// 	}
// 	sortedSet.elementCount = sortedSet.skiplist.length
